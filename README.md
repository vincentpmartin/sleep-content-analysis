...
## HTML files
The analyse files corresponding to the [current study](./results_notebook_htmlMartinGauld2022.html) and of the [seminal paper from Eiko Fried (2017)](./results_notebook_html/Fried2017.html) are available in this repository. <br>
...
* If you do not even know what a Jupyer Notebook is, please click on 👉[this link](https://mybinder.org/v2/gh/vincentpmartin/sleep-content-analysis/HEAD?labpath=jupyter_notebook_sleep_content_analysis.ipynb)👈, wait a few second for the binder server to launch, and follows the instructions in the notebook. 
